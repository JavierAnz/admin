...
import { g as getDbConnection } from './db_BFHI2weh.mjs';
import { P as PERMS } from './brand_DjbZtpcq.mjs';

const getConnection = getDbConnection;
async function buscarLocal(queryRaw = "", agencia = "", soloLocal = false, userPerms = []) {
  try {
...
export { buscarLocal as b, getConnection as g };
